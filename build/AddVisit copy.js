    ...
    _defineProperty(this, "submit", (values, {
      ...
      fetch(url + 'visit', {
        ...
        body: JSON.stringify({ ...values,
          ...
          clinicName: ((_this$state$allMyClin = this.state.allMyClinics.find(clinic => clinic._id === values.clinic)) === null || _this$state$allMyClin === void 0 ? void 0 : _this$state$allMyClin.name) || 'name not found'
        })
