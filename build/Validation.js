...
const firstName = Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required');
const lastName = Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required');
...
export const AddVisitSchema = Yup.object().shape({
  ...
  date: Yup.string().min(2, 'Enter Date and Time').required('Required') // materials: Yup.array().min(1, "Choose at least one type of materials")
  // firstName, lastName,
