import { Children, createContext, useContext, useRef, useEffect, useReducer, useCallback, useMemo, createElement, forwardRef, useLayoutEffect, Component } from './react.js';
import { c as createCommonjsModule, u as unwrapExports } from './common/_commonjsHelpers-6a48b99e.js';
import './common/index-3e17ad53.js';
import { i as invariant, h as hoistNonReactStatics } from './common/hoist-non-react-statics.cjs-637ed137.js';
...
var scheduler = {LowPriority: scheduler_production_min,unstable_runWithPriority: scheduler_development};
...
function useFormik(_ref) {
  ...
  var validateFormWithLowPriority = useEventCallback(function (values) {
    ...
    return scheduler_2(scheduler_1, function () {
...
function useField(propsOrFieldName) {
  ...
  var isAnObject = isObject$1(propsOrFieldName);
  ...
  if (isObject$1(propsOrFieldName)) {
  ...
  useEffect(function () {
    {
      ...
      !!(is && children && isFunction$1(children)) ?  invariant(false, 'You should not use <Field as> and <Field children> as a function in the same <Field> component; <Field as> will be ignored.')  : void 0;
      !!(component && children && isFunction$1(children)) ?  invariant(false, 'You should not use <Field component> and <Field children> as a function in the same <Field> component; <Field component> will be ignored.')  : void 0;
...
function (_React$Component) {
  ...
  function FastField(props) {
    ...
    !!(is && children && isFunction$1(children)) ?  invariant(false, 'You should not use <FastField as> and <FastField children> as a function in the same <FastField> component; <FastField as> will be ignored.')  : void 0;
    !!(component && children && isFunction$1(children)) ?  invariant(false, 'You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.')  : void 0;
...
export { ErrorMessage, FastField, Field, FieldArray, Form, Formik, FormikConsumer, FormikContext, FormikProvider, connect, getActiveElement, getIn, insert, isEmptyChildren, isFunction$1 as isFunction, isInputEvent, isInteger, isNaN$1 as isNaN, isObject$1 as isObject, isPromise, isString, move, replace, setIn, setNestedObjectValues, swap, useField, useFormik, useFormikContext, validateYupSchema, withFormik, yupToFormErrors };
